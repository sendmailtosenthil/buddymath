    ...
    me.SpriteObject = me.Renderable.extend(
        /** @scope me.SpriteObject.prototype */
        {
            ...
            init : function(x, y, image, spritewidth, spriteheight) {
                ...
                this.image = image;
                   console.log('wwwwww',this.image.width);
    ...
    me.AnimationSheet = me.SpriteObject.extend(
        /** @scope me.AnimationSheet.prototype */
        {
            ...
            buildLocalAtlas : function (atlas, indices) {
                //console.log('build local',atlas, indices);
                ...
                if (atlas !== undefined) {
                    ...
                    /*console.log(this.image.width, this.margin, this.width, this.spacing);
                    console.log(this.image.height, this.margin, this.height, this.spacing);*/
            ...
            addAnimation : function(name, index, animationspeed) {
                //console.log('Adding animation', name, index);
                this.anim[name] = {
                    name : name,
                    frame : [],
                    idx : 0,
		 ...
		 * }).bind(this));
            ...
            setCurrentAnimation : function(name, resetAnim) {
                if (this.anim[name]) {
                    ...
                    //console.log('Set Current animation');
